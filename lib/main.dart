  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      ...
      child: MaterialApp.router(
        ...
        //           MapScreen(geoPoint: state.extra as GeoPoint),
        //     ),
        //     GoRoute(
        //       path: '/ChatRoom',
        ...
        //       path: '/ClassDetail',
        //       builder: (context, state) =>
        //           ClassDetail(classRoom: state.extra as Class),
        //     ),
        //     GoRoute(
        //       path: '/Camera',
        ...
        //         studentId: (state.extra as Map<String, dynamic>)['studentId']
        //             as String,
        //       ),
        //     ),
        //     GoRoute(
        ...
        //         submissions:
        //             (state.extra as Map)['submissions'] as List<Submission>,
